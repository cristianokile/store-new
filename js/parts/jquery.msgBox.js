...
function msg (options) {
    ...
    var divTitle = "<div class=\"msbBoxImage\"><img src=\"img/msgbox/checked.png\"></div><div class=\"msgBoxTitle\">" + options.title + "</div>";
    ...
    var left = windowWidth / 2 - width / 1.75;
    ...
    function hide() {
        ...
        options.beforeClose();
        divMsgBox.animate({ opacity: 0, "top": top - 50, "left": left }, 1200);
        divMsgBoxBackGround.fadeOut(1400);
        setTimeout(function () { divMsgBox.remove(); divMsgBoxBackGround.remove(); }, 1400);
        setTimeout(options.afterClose, 1400);
        isShown = false;
